...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_STATIC_DEN - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_DRACONIC_HOLLOW - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_GIGA_TEMPLE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,
    [MAPSEC_ROUTE_100 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD
};
...
static const u8 sRegionMapSectionId_To_PopUpThemeIdMapping_BW[] =
{
    ...
    [MAPSEC_STATIC_DEN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_DRACONIC_HOLLOW] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_GIGA_TEMPLE] = MAPPOPUP_THEME_BW_DEFAULT,
