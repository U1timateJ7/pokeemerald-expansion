...
enum FlagsVarsDebugMenu
{
    ...
    DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_ENCOUNTERS,
    DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_EVOLUTIONS,
};
...
static const struct ListMenuItem sDebugMenu_Items_Party[] =
{
    ...
    [DEBUG_PARTY_MENU_ITEM_MAX_FRIENDSHIP]  = {COMPOUND_STRING("Max Friendship"),  DEBUG_PARTY_MENU_ITEM_MAX_FRIENDSHIP},
...
static const struct ListMenuItem sDebugMenu_Items_FlagsVars[] =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_ENCOUNTERS]= {COMPOUND_STRING("Toggle {STR_VAR_1}RND Encounters"),         DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_ENCOUNTERS},
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_EVOLUTIONS]= {COMPOUND_STRING("Toggle {STR_VAR_1}RND Evolutions"),         DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_EVOLUTIONS},
};
...
static void (*const sDebugMenu_Actions_Flags[])(u8) =
{
    ...
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_ENCOUNTERS]= DebugAction_FlagsVars_ToggleRandomEncounters,
    [DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_EVOLUTIONS]= DebugAction_FlagsVars_ToggleRandomEvolutions,
};
...
static u8 Debug_CheckToggleFlags(u8 id)
{
    ...
    switch (id)
    {
        ...
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_FRONTIER_PASS:
            ...
            break;
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_ENCOUNTERS:
            result = FlagGet(FLAG_RANDOM_ENCOUNTERS);
            break;
        case DEBUG_FLAGVAR_MENU_ITEM_TOGGLE_RND_EVOLUTIONS:
